...
Namespace UseLinkEvents
    ...
    Public Partial Class Form1
        ...
        Private backColor As Color = Color.LightGreen

        Private foreColor As Color = Color.Green

        ' Create the Marginal Header section. 
        Private Sub link1_CreateMarginalHeaderArea(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
        ...
        Private Sub link1_CreateDetailArea(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
            ...
            Dim r As Rectangle = New Rectangle(0, 0, 150, 50)
            ...
            img.MakeTransparent()
            e.Graph.DrawImage(img, New Rectangle(200 + (50 - img.Width) \ 2, top + (50 - img.Height) \ 2, img.Width, img.Height), BorderSide.None, Color.Transparent)
        End Sub
